...
INSERT INTO `admin_system`.`menus_table` (`id`, `pid`, `menusCode`, `companyId`, `departId`, `status`, `name`, `path`, `component`, `hidden`, `is_external_link`, `sortNo`, `meta`, `createName`, `createUserId`) VALUES ('4', '2', 'SYS_MGT_MENUS_EDIT', '1', '1', '1', '编辑菜单', 'edit', '/system/menuMgt/edit', 'true', 'false', '2', '{"title": "编辑菜单","noCache": false,"activeMenu": "/system/menuMgt","icon": '',"breadcrumb": true,"affix": false,"is_local": false}', 'admin', '1');
INSERT INTO `admin_system`.`menus_table` (`id`, `pid`, `menusCode`, `companyId`, `departId`, `status`, `name`, `path`, `component`, `hidden`, `is_external_link`, `sortNo`, `meta`, `createName`, `createUserId`) VALUES ('5', '2', 'SYS_MGT_MENUS_CREATE', '1', '1', '1', '添加菜单', 'create', '/system/menuMgt/create', 'true', 'false', '3', '{ "title": "添加菜单","activeMenu": "/system/menuMgt","icon": '',"noCache": false,"breadcrumb": true,"affix": false,"is_local": false}', 'admin', '1');
