...
import TreeNodeDialog from '@/views/systemTools/formGenerator/list/TreeNodeDialog'
import { isNumberStr } from '@/utils/form-generator/index'
import IconsDialog from './IconsDialog'
import {
  inputComponents, selectComponents
} from '@/components/form-generator/generator/config'
import { saveFormConf } from '@/utils/form-generator/db'
